...
const Navbar = () => {
  ...
  const menuItems = <>
    ...
    <li className='text-white'><Link to='/purchase'>Purchase</Link></li>
  ...
  return (
    <div>
      <div class="navbar bg-base-100 bg-[#0072c4]">
      <div class="navbar-start">
        ...
        <a class="btn btn-ghost normal-case text-xl text-white">Subaru MF</a>
      </div>
